      ...
      <section className="py-16 bg-white dark:bg-dark-bg">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              { title: 'Kurikulum Merdeka', items: ['Pembelajaran berbasis projek (P5RA)', 'Fleksibilitas guru dalam merancang pembelajaran', 'Pengembangan profil pelajar Pancasila dan Rahmatan lil Alamin', 'Asesmen formatif dan sumatif berbasis kompetensi'] },
              { title: 'Kekhasan Madrasah', items: ['Al-Qur\'an Hadits', 'Akidah Akhlak', 'Fiqih', 'Sejarah Kebudayaan Islam (SKI)', 'Bahasa Arab'] },
              { title: 'Muatan Nasional', items: ['Pendidikan Pancasila', 'Bahasa Indonesia', 'Matematika', 'IPA Terpadu', 'IPS Terpadu'] },
              { title: 'Muatan Tambahan', items: ['Tahfidz Qur\'an', 'Bahasa Inggris Intensif', 'Kitab Kuning Dasar', 'Praktik Ibadah', 'Keterampilan Digital'] },
            ].map((item, i) => (

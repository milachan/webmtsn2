...
function Lightbox({ item, onClose, onPrev, onNext }: { item: GaleriItem; onClose: () => void; onPrev: () => void; onNext: () => void }) {
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        <button onClick={onClose} className="absolute -top-12 right-0 text-white/75 hover:text-white transition-colors text-sm">Tutup [ESC]</button>
      </motion.div>
    </motion.div>
  );
}

...
import { useStoreData, getGuru } from '@/lib/adminStore';
import Link from 'next/link';

export default function GuruTendikPage() {
  const guruTendik = useStoreData(getGuru);
  return (
      ...
      <section className="relative py-16 bg-gradient-to-br from-emerald-900 via-emerald-800 to-green-900 overflow-hidden">
        ...
        <div className="relative z-10 max-w-8xl 2xl:max-w-9xl mx-auto px-4 sm:px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-lg text-white/85">Tenaga pendidik dan kependidikan MTs Negeri 2 Kebumen</p>
          </motion.div>
        </div>
      </section>
